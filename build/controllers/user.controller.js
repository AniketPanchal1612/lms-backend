...
exports.registerUser = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
exports.activateUser = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
exports.loginUser = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
// logout user
exports.logoutUser = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
//update access_token bcs expires 5m and refresh_token expires 3d
exports.updateAccessToken = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
...
// get user info
exports.getUserInfo = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
        const userId = req.user?._id;
...
//social auth
exports.socialAuth = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
// update user info
exports.updateUserInfo = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
        ...
        //     }
        //     user.email = email; //save new entered email
        // }
        if (name && user) {
            user.name = name;
        }
...
exports.updatePassword = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
exports.updateProfilePicture = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
// get all users - admin
exports.getAllUsers = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
exports.updateUserRole = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
...
// delete user -admin
exports.deleteUser = (0, asyncErrorHandler_1.AsyncErrorHandler)(async (req, res, next) => {
    try {
        const { id } = req.params;
